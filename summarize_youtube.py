...
def render_html(days, hours, minutes, total_seconds):
    template = Template("""
    <html>
    ...
    """)
    return template.render(days=days, hours=hours, minutes=minutes, total_seconds=total_seconds)


def main():
    if not YOUTUBE_API_KEY or not CHANNEL_ID:
        raise Exception("Missing YOUTUBE_API_KEY or YOUTUBE_CHANNEL_ID environment variable.")
    ...
    html = render_html(days, hours, minutes, total_seconds)
